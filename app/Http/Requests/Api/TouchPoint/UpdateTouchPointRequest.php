...
class UpdateTouchPointRequest extends FormRequest {
    ...
    public function rules(): array {
        return [
            ...
            'contact_type'           => ['sometimes', Rule::in(['personal', 'business'])],
            'contact_method'         => ['sometimes', Rule::in(['call', 'text', 'meetup'])],
            'touch_point_start_date' => ['sometimes', 'date'],
            'touch_point_start_time' => ['sometimes', 'date_format:H:i'],
            'frequency'              => ['sometimes', Rule::in(['daily', 'weekly', 'monthly', 'custom'])],
            'custom_days'            => [
                'integer',
                'min:1',
                'max:365',
