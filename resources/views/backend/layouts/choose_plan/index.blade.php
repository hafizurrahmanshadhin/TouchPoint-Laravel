                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ChoosePlan</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('choose.plan.create') }}" class="btn btn-primary btn-sm" id="addNewPage">Add
                            ChoosePlan</a>
                    </div>
                    <div class="card-body">
                        <table id="datatable"
...
@push('scripts')
    ...
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('choose.status', ':id') }}';
        ...
        function deleteItem(id) {
            let url = '{{ route('choose.plan.destroy', ':id') }}';
            let csrfToken = '{{ csrf_token() }}';
            $.ajax({
                type: "DELETE",
                url: url.replace(':id', id),
